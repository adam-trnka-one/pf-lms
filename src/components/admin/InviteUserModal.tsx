      ...
      <div className="relative top-10 mx-auto max-w-4xl">
        <div className="bg-white rounded-lg shadow-lg overflow-hidden">
            ...
            <div className="absolute -bottom-12 left-8">
              <div className="h-24 w-24 rounded-full border-4 border-white bg-white shadow-md">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                  <UserPlus className="h-12 w-12 text-[#ff751d] mx-auto" />
                </div>
              </div>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="pt-16 pb-8 px-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-1">Invite New User</h2>
            <p className="text-sm text-gray-500 mb-8">Send an invitation to join the platform</p>
            ...
            <div className="grid grid-cols-1 gap-y-8 gap-x-6 sm:grid-cols-2">
              ...
              <div className="space-y-6">
                ...
                <h3 className="text-lg font-medium text-gray-900 border-b pb-2 mt-8">Initial Permissions</h3>
